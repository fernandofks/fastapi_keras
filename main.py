...
app = FastAPI()
input = np.array([[[-0.198,  0.629,  0.259,  0.094,  0.628,  0.307,-0.198,  0.629,  0.259,  0.094,  0.628,  0.307],
       [-0.198,  0.629,  0.259,  0.094,  0.628,  0.307,-0.198,  0.629,  0.259,  0.094,  0.628,  0.307],
       [-0.198,  0.629,  0.259,  0.094,  0.628,  0.307,-0.198,  0.629,  0.259,  0.094,  0.628,  0.307],
       [-0.198,  0.629,  0.259,  0.094,  0.628,  0.307,-0.198,  0.629,  0.259,  0.094,  0.628,  0.307],
    [-0.198,  0.629,  0.259,  0.094,  0.628,  0.307,-0.198,  0.629,  0.259,  0.094,  0.628,  0.307],
        [-0.198,  0.629,  0.259,  0.094,  0.628,  0.307,-0.198,  0.629,  0.259,  0.094,  0.628,  0.307],
       [-0.198,  0.628,  0.259,  0.094,  0.628,  0.307,-0.198,  0.629,  0.259,  0.094,  0.628,  0.307]]])
...
async def predicting(UserInput):
    ...
    input = np.append(input[0],[lista],axis=0).reshape(1,8,12)
    input = input[:,1:,:]
